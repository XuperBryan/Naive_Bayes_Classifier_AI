...
bool NaiveBayes::willDie(int sex, int type, int tubed, int pneumon, int age, int preg, int diabete, int copd, int asthma, int inmsupr, int hyper, int other, int cardio, int obese, int renal, int tobacco, int contact, int covres, int icu){
    ...
    if(diabete==1){
        probDie+=1.5*log(ddiabete1/dCount);
        probLive+=1.5*log(adiabete1/aCount);
    } else if(diabete==2){
        probDie+=1.5*log(ddiabete2/dCount);
        probLive+=1.5*log(adiabete2/aCount);
    } else {
        probDie+=1.5*log(ddiabete3/dCount);
        probLive+=1.5*log(adiabete3/aCount);
    }
