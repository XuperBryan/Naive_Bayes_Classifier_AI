...
bool NaiveBayes::willDie(int sex, int type, int tubed, int pneumon, int age, int preg, int diabete, int copd, int asthma, int inmsupr, int hyper, int other, int cardio, int obese, int renal, int tobacco, int contact, int covres, int icu){
    ...
    if(pneumon==1){
        probDie+=1.75*log(dpneumon1/dCount);
        probLive+=1.75*log(apneumon1/aCount);
    } else if(pneumon==2){
        probDie+=1.75*log(dpneumon2/dCount);
        probLive+=1.75*log(apneumon2/aCount);
    } else {
        probDie+=1.75*log(dpneumon3/dCount);
        probLive+=1.75*log(apneumon3/aCount);
    }
