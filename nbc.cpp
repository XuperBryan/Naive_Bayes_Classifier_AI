...
bool NaiveBayes::willDie(int sex, int type, int tubed, int pneumon, int age, int preg, int diabete, int copd, int asthma, int inmsupr, int hyper, int other, int cardio, int obese, int renal, int tobacco, int contact, int covres, int icu){
    ...
    if(tobacco==1){
        probDie+=1.75*log(dtobacco1/dCount);
        probLive+=1.75*log(atobacco1/aCount);
    } else if(tobacco==2){
        probDie+=1.75*log(dtobacco2/dCount);
        probLive+=1.75*log(atobacco2/aCount);
    } else {
        probDie+=1.75*log(dtobacco3/dCount);
        probLive+=1.75*log(atobacco3/aCount);
    }
