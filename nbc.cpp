...
bool NaiveBayes::willDie(int sex, int type, int tubed, int pneumon, int age, int preg, int diabete, int copd, int asthma, int inmsupr, int hyper, int other, int cardio, int obese, int renal, int tobacco, int contact, int covres, int icu){
    ...
    if(sex==1){
        probDie+=0.25*log(dsex1/dCount);
        probLive+=0.25*log(asex1/aCount);
    } else if(sex==2){
        probDie+=0.25*log(dsex2/dCount);
        probLive+=0.25*log(asex2/aCount);
    } 
    ...
    if(tubed==1){
        probDie+=2.2*log(dtubed1/dCount);
        probLive+=2.2*log(atubed1/aCount);
    } else if(tubed==2){
        probDie+=2.2*log(dtubed2/dCount);
        probLive+=2.2*log(atubed2/aCount);
    } else {
        probDie+=2.2*log(dtubed3/dCount);
        probLive+=2.2*log(atubed3/aCount);
    }

    if(pneumon==1){
        probDie+=1.5*log(dpneumon1/dCount);
        probLive+=1.5*log(apneumon1/aCount);
    } else if(pneumon==2){
        probDie+=1.5*log(dpneumon2/dCount);
        probLive+=1.5*log(apneumon2/aCount);
    } else {
        probDie+=1.5*log(dpneumon3/dCount);
        probLive+=1.5*log(apneumon3/aCount);
    }
    ...
    if(preg==1){
        probDie+=1.5*log(dpreg1/dCount);
        probLive+=1.5*log(apreg1/aCount);
    } else if(preg==2){
        probDie+=1.5*log(dpreg2/dCount);
        probLive+=1.5*log(apreg2/aCount);
    } else {
        probDie+=1.5*log(dpreg3/dCount);
        probLive+=1.5*log(apreg3/aCount);
    }
    ...
    if(inmsupr==1){
        probDie+=1.25*log(dinmsupr1/dCount);
        probLive+=1.25*log(ainmsupr1/aCount);
    } else if(inmsupr==2){
        probDie+=1.25*log(dinmsupr2/dCount);
        probLive+=1.25*log(ainmsupr2/aCount);
    } else {
        probDie+=1.25*log(dinmsupr3/dCount);
    ...
    //     probLive+=.25*log(aother1/aCount);
    // } else if(other==2){
    //     probDie+=.25*log(dother2/dCount);
    //     probLive+=.25*log(aother2/aCount);
    // } else {
    //     probDie+=.25*log(dother3/dCount);
    //     probLive+=.25*log(aother3/aCount);
    // }
    ...
    if(obese==1){
        probDie+=1.5*log(dobese1/dCount);
        probLive+=1.5*log(aobese1/aCount);
    } else if(obese==2){
        probDie+=1.5*log(dobese2/dCount);
        probLive+=1.5*log(aobese2/aCount);
    } else {
        probDie+=1.5*log(dobese3/dCount);
        probLive+=1.5*log(aobese3/aCount);
    }
    
    if(renal==1){
        probDie+=.5*log(drenal1/dCount);
        probLive+=.5*log(arenal1/aCount);
    } else if(renal==2){
        probDie+=.5*log(drenal2/dCount);
        probLive+=.5*log(arenal2/aCount);
    } else {
        probDie+=.5*log(drenal3/dCount);
        probLive+=.5*log(arenal3/aCount);
    }
    
    if(tobacco==1){
        probDie+=1.5*log(dtobacco1/dCount);
        probLive+=1.5*log(atobacco1/aCount);
    } else if(tobacco==2){
        probDie+=1.5*log(dtobacco2/dCount);
        probLive+=1.5*log(atobacco2/aCount);
    } else {
        probDie+=1.5*log(dtobacco3/dCount);
        probLive+=1.5*log(atobacco3/aCount);
    }
    ...
    if(covres==1){
        probDie+=3*log(dcovres1/dCount);
        probLive+=3*log(acovres1/aCount);
    } else if(covres==2){
        probDie+=3*log(dcovres2/dCount);
        probLive+=3*log(acovres2/aCount);
    } else {
        probDie+=3*log(dcovres3/dCount);
        probLive+=3*log(acovres3/aCount);
    }
    
    if(icu==1){
        probDie+=.75*log(dicu1/dCount);
        probLive+=.75*log(aicu1/aCount);
    } else if(icu==2){
        probDie+=.75*log(dicu2/dCount);
        probLive+=.75*log(aicu2/aCount);
    } else {
        probDie+=.75*log(dicu3/dCount);
        probLive+=.75*log(aicu3/aCount);
    }
